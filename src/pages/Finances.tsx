    ...
    <div className="income-page">
      <div className="page-header">
        <div>
          ...
          <p>
            <strong>Налични пари</strong> — баланс по <strong>каса (в брой)</strong> и <strong>сметка</strong>, изчислен от
            приходи, плащания в «Задължения» и разходи (миграция 056: без ръчна каса в настройките). Останалите табове са
            по избрана година: <strong>други приходи</strong> (при нужда въвеждане с къде влиза сумата) и разходи. Такси
